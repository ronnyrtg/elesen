    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TradingLicense.Data.LicenseApplicationContext>
    {
        ...
        protected override void Seed(TradingLicense.Data.LicenseApplicationContext context)
        {
            ...
            var sector = new List<SECTOR>
            {
                ...
                new SECTOR {SECTORID=7,SECTORDESC="Pasar Am"},
                new SECTOR {SECTORID=8,SECTORDESC="Pasar Persendirian"},
            };
            ...
            var bcode = new List<BC>
            {
                ...
                new BC {LIC_TYPEID=1,SECTORID=1,C_R="A58",C_R_DESC="Joki kereta",DEF_RATE=0.0f,BASE_FEE=100.0f,PERIOD=1,PERIOD_Q=1},                
                ...
                new BC {LIC_TYPEID=3,C_R="H01",C_R_DESC="Hotel (Kelas Pertama)",DEF_RATE=0.0f,O_FEE=150.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=3,C_R="H02",C_R_DESC="Hotel (Kelas Kedua)",DEF_RATE=0.0f,O_FEE=100.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=3,C_R="H03",C_R_DESC="Hotel (Kelas Ketiga)",DEF_RATE=0.0f,O_FEE=30.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=3,C_R="H04",C_R_DESC="Lodging House/Rumah Tumpangan",DEF_RATE=0.0f,O_FEE=30.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=4,C_R="I01",C_R_DESC="Pengurusan Skrap/Dealing in Scrap",DEF_RATE=0.0f,BASE_FEE=50.0f,PERIOD=2,PERIOD_Q=1},
                ...
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L01",C_R_DESC="Pasar Malam",P_FEE=1.0f,PERIOD=4,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L02",C_R_DESC="Ikan",P_FEE=30.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L03",C_R_DESC="Ayam",P_FEE=30.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L04",C_R_DESC="Daging",P_FEE=30.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L05",C_R_DESC="Sayur-sayuran/buah-buahan/telur",P_FEE=20.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=7,C_R="L06",C_R_DESC="Barang-barang lain",P_FEE=20.0f,PERIOD=2,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=8,C_R="L07",C_R_DESC="Pasar Persendirian - Luas lantai 70 meter persegi atau lebih",BASE_FEE=225.0f,PERIOD=1,PERIOD_Q=1},
                new BC {LIC_TYPEID=7,SECTORID=8,C_R="L08",C_R_DESC="Pasar Persendirian - Luas lantai kurang daripada 70 meter persegi",BASE_FEE=175.0f,PERIOD=1,PERIOD_Q=1},
                ...
                new BC {LIC_TYPEID=8,C_R="M03",C_R_DESC="Rumah Awam (Kelas 1)",DEF_HOUR="10.00 pagi hingga 12.00 malam",EX_HOUR_FEE=30.0f,PERIOD=2,PERIOD_Q=1,P_FEE=110.0f},
                new BC {LIC_TYPEID=8,C_R="M04",C_R_DESC="Rumah Awam (Kelas 2)",DEF_HOUR="10.00 pagi hingga 10.00 malam",EX_HOUR_FEE=30.0f,PERIOD=2,PERIOD_Q=1,P_FEE=80.0f},
                new BC {LIC_TYPEID=8,C_R="M05",C_R_DESC="Rumah Awam (Kelas 3)",DEF_HOUR="10.00 pagi hingga 9.00 malam",EX_HOUR_FEE=30.0f,PERIOD=2,PERIOD_Q=1,P_FEE=55.0f},
                new BC {LIC_TYPEID=8,C_R="M06",C_R_DESC="Rumah Bir (Kelas 1)",DEF_HOUR="10.00 pagi hingga 12.00 malam",EX_HOUR_FEE=15.0f,PERIOD=2,PERIOD_Q=1,P_FEE=55.0f},
                new BC {LIC_TYPEID=8,C_R="M07",C_R_DESC="Rumah Bir (Kelas 2)",DEF_HOUR="10.00 pagi hingga 10.00 malam",EX_HOUR_FEE=15.0f,PERIOD=2,PERIOD_Q=1,P_FEE=35.0f},
                ...
                new BC {LIC_TYPEID=9,C_R="N01",C_R_DESC="Lesen Pemberi Pinjam Wang",PERIOD=1,PERIOD_Q=2,P_FEE=2000.0f},
                ...
                new BC {LIC_TYPEID=10,C_R="P03",C_R_DESC="Pameran Filem Sinematograf - Dalam panggung/panggung wayang",O_FEE=5.0f,O_NAME="pertunjukan",PERIOD=0,PERIOD_Q=0},
            ...
            var accesspages = new List<ACCESSPAGE>
            {
                ...
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=1,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=2,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=3,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=4,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=5,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=6,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=0,ROLEID=7,SCREENID=15},
                new ACCESSPAGE {PAGEDESC="Developer",CRUDLEVEL=4,ROLEID=8,SCREENID=15},
            };
