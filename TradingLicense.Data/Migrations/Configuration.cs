    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TradingLicense.Data.LicenseApplicationContext>
    {
        ...
        protected override void Seed(TradingLicense.Data.LicenseApplicationContext context)
        {
            ...
            var AppStatus = new List<APPSTATUS>
            {
                ...
                new APPSTATUS {STATUSDESC="Print License" ,PROGRESS =95},
            ...
            {
                new COMPANY {REG_NO="75278-T",C_NAME="Chin Recycle",C_PHONE="087430010",SSMREGDATE=DateTime.Parse("01-01-2018"),SSMEXPDATE=DateTime.Parse("31-12-2018")},
                new COMPANY {REG_NO="801234-V",C_NAME="Kejora Bersatu Sdn Bhd",C_PHONE="087450690",SSMREGDATE=DateTime.Parse("01-06-2017"),SSMEXPDATE=DateTime.Parse("30-06-2018")},
                new COMPANY {REG_NO="991345-V",C_NAME="Kentucky Fried Chicken (KFC)",C_PHONE="087421090",SSMREGDATE=DateTime.Parse("11-Aug-2018"),SSMEXPDATE=DateTime.Parse("12-Aug-2019")},
                new COMPANY {REG_NO="129074-M",C_NAME="Marry Brown",C_PHONE="087-411555",SSMREGDATE=DateTime.Parse("13-Oct-2018"),SSMEXPDATE=DateTime.Parse("12-Oct-2019")},
                new COMPANY {REG_NO="203976-T",C_NAME="Borneo Combat Gym",C_PHONE="011-3516 1698",SSMREGDATE=DateTime.Parse("01-Feb-2018"),SSMEXPDATE=DateTime.Parse("01-Feb-2019")},
                new COMPANY {REG_NO="987264-H",C_NAME="Dorsett Grand Labuan",C_PHONE="+608 7422 000",SSMREGDATE=DateTime.Parse("01-Jan-2018"),SSMEXPDATE=DateTime.Parse("01-Jan-2019")},
                new COMPANY {REG_NO="987264-H",C_NAME="Red Tomato Hotel",C_PHONE="087-412 963",SSMREGDATE=DateTime.Parse("01-Nov-2018"),SSMEXPDATE=DateTime.Parse("01-Nov-2019")},
                new COMPANY {REG_NO="355817-T",C_NAME="Olympic Pool & Snooker",C_PHONE="087-467522",SSMREGDATE=DateTime.Parse("01-Mar-2018"),SSMEXPDATE=DateTime.Parse("01-Mar-2019")},
                new COMPANY {REG_NO="188846-T",C_NAME="Kedai Gunting Rambut Wahab",SSMREGDATE=DateTime.Parse("01-Feb-2018"),SSMEXPDATE=DateTime.Parse("01-Feb-2019")},
                new COMPANY {REG_NO="203433-V",C_NAME="Klinik Suria (Labuan) Sdn. Bhd.",C_PHONE="087-504 969",SSMREGDATE=DateTime.Parse("01-Apr-2018"),SSMEXPDATE=DateTime.Parse("01-Apr-2019")},
                new COMPANY {REG_NO="203433-V",C_NAME="Wong Brothers Workshop & Service Sdn. Bhd.",C_PHONE="087-414 784",SSMREGDATE=DateTime.Parse("21-Jan-2018"),SSMEXPDATE=DateTime.Parse("21-Jan-2019")},
                new COMPANY {REG_NO="203433-V",C_NAME="Hobby Mix.",C_PHONE="087-429 428",SSMREGDATE=DateTime.Parse("31-Jan-2018"),SSMEXPDATE=DateTime.Parse("31-Jan-2019")},
