namespace TradingLicense.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TradingLicense.Data.LicenseApplicationContext>
    {
        ...
        protected override void Seed(TradingLicense.Data.LicenseApplicationContext context)
        {
            ...
            {
                new BusinessCode {CodeNumber="A001",SectorID=1,CodeDesc="Pejabat urusan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A002",SectorID=1,CodeDesc="Kemudahan dan perkhidmatan jagaan kesihatan swasta",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A003",SectorID=1,CodeDesc="Bank dan institusi kewangan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A004",SectorID=1,CodeDesc="Kedai buku dan alat tulis",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A005",SectorID=1,CodeDesc="Institusi pendidikan tinggi swasta, sekolah swasta atau institusi pendidikan swasta",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A006",SectorID=1,CodeDesc="Barangan elektrik atau elektronik atau komputer",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A007",SectorID=1,CodeDesc="Perabot",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A008",SectorID=1,CodeDesc="Hiasan dalaman/barangan hiasan dalaman",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A009",SectorID=1,CodeDesc="Peralatan dan perkakasan rumah/pejabat",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A010",SectorID=1,CodeDesc="Peralatan dan kelengkapan dapur",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A011",SectorID=1,CodeDesc="Perkhidmatan menjahit",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A012",SectorID=1,CodeDesc="Pakaian, tekstil dan alat jahitan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A013",SectorID=1,CodeDesc="Kosmetik dan kelengkapan dandanan diri",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A014",SectorID=1,CodeDesc="Peralatan makmal, saintifik dan perubatan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A015",SectorID=1,CodeDesc="Ubat, farmasi dan produk kesihatan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A016",SectorID=1,CodeDesc="Barang kemas, hiasan diri dan persendirian",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A017",SectorID=1,CodeDesc="Jam",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A018",SectorID=1,CodeDesc="Bagasi",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A019",SectorID=1,CodeDesc="Cenderamata",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A020",SectorID=1,CodeDesc="Barangan optik",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A021",SectorID=1,CodeDesc="Peralatan, aksesori dan perkhidmatan fotografi",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A022",SectorID=1,CodeDesc="Bunga dan tumbuhan tiruan/hidup",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A023",SectorID=1,CodeDesc="Perkhidmatan andaman dan pakaian pengantin",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A024",SectorID=1,CodeDesc="Telefon dan aksesori",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A025",SectorID=1,CodeDesc="Barangan antik",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A026",SectorID=1,CodeDesc="Menjilid buku atau membuat fotokopi",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A027",SectorID=1,CodeDesc="Tukang kunci",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A028",SectorID=1,CodeDesc="Pusat/studio rakaman audio",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A029",SectorID=1,CodeDesc="Stesen minyak/gas/elektrik",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A030",SectorID=1,CodeDesc="Media digital/elektronik dan aksesori berkaitan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A031",SectorID=1,CodeDesc="Barangan logam (untuk sektor pembinaan dan pembuatan)",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A032",SectorID=1,CodeDesc="Alat-alat muzik atau kelengkapan muzik",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A033",SectorID=1,CodeDesc="Kelas kesenian/kebudayaan/kemahiran",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A034",SectorID=1,CodeDesc="Peralatan, bahan dan hiasan landskap",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A035",SectorID=1,CodeDesc="Kenderaan berat",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A036",SectorID=1,CodeDesc="Kereta, motosikal, bot dan jet ski",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A037",SectorID=1,CodeDesc="Mesin dan jentera",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A038",SectorID=1,CodeDesc="Basikal dan aksesori",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A039",SectorID=1,CodeDesc="Peralatan kesihatan, kecergasan dan sukan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A040",SectorID=1,CodeDesc="Produk berasaskan tembakau (seperti rokok/curut dan produk seumpamanya)",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A041",SectorID=1,CodeDesc="Kemasan bangunan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A042",SectorID=1,CodeDesc="Alat permainan dan barangan hobi",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A043",SectorID=1,CodeDesc="Percetakan digital",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A044",SectorID=1,CodeDesc="Kedai barangan runcit/kedai serbaneka (seperti pasar raya dan gedung)",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A045",SectorID=1,CodeDesc="Sewaan kereta",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A046",SectorID=1,CodeDesc="Haiwan peliharaan, dandanan binatang, peralatan dan makanan haiwan dan/atau rumah tumpangan haiwan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A047",SectorID=1,CodeDesc="Agensi teman sosial",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A048",SectorID=1,CodeDesc="Kedai bebas cukai",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A049",SectorID=1,CodeDesc="Pengurusan mayat dan pengebumian",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A050",SectorID=1,CodeDesc="Baja, racun atau kimia-kimia lain yang serupa",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A051",SectorID=1,CodeDesc="Bahan berbahaya yang mudah terbakar tidak termasuk petroleum dan gas",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A052",SectorID=1,CodeDesc="Dobi",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A053",SectorID=1,CodeDesc="Stor kayu",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A054",SectorID=1,CodeDesc="Agensi pelancongan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A055",SectorID=1,CodeDesc="Agensi pekerjaan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A056",SectorID=1,CodeDesc="Jualan tiket pengangkutan awam",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A057",SectorID=1,CodeDesc="Pusat kecantikan dan penjagaan kesihatan",DefaultRate=25f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A058",SectorID=1,CodeDesc="Joki kereta",DefaultRate=0.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="A059",SectorID=1,CodeDesc="Pemberi Pinjam Wang",DefaultRate=0.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=2},
                new BusinessCode {CodeNumber="B001",SectorID=2,CodeDesc="Gudang/stor makanan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="B002",SectorID=2,CodeDesc="Gudang/stor barang-barang lain",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="B003",SectorID=2,CodeDesc="Gudang/stor bahan merbahaya",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C001",SectorID=3,CodeDesc="Barang-barang berasaskan logam",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C002",SectorID=3,CodeDesc="Media digital dan elektronik",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C003",SectorID=3,CodeDesc="Makanan dan perkakasan haiwan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C004",SectorID=3,CodeDesc="Baja",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C005",SectorID=3,CodeDesc="Kenderaan, jentera dan mesin",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C006",SectorID=3,CodeDesc="Alat-alat ganti dan aksesori kenderaan bermotor",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C007",SectorID=3,CodeDesc="Basikal",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C008",SectorID=3,CodeDesc="Tayar dan tiub",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C009",SectorID=3,CodeDesc="Bahan binaan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C010",SectorID=3,CodeDesc="Bateri",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C011",SectorID=3,CodeDesc="Kabel dan wayar",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C012",SectorID=3,CodeDesc="Permaidani dan hamparan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C013",SectorID=3,CodeDesc="Keranda dan batu nisan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C014",SectorID=3,CodeDesc="Kosmetik dan kelengkapan dandanan diri",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C015",SectorID=3,CodeDesc="Bahan pencuci, alat-alat mencuci bahan-bahan lain yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C016",SectorID=3,CodeDesc="Bahan pengilap",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C017",SectorID=3,CodeDesc="Mengisi gas ke dalam botol atau silinder",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C018",SectorID=3,CodeDesc="Dadah/ubat-ubatan dan keluaran-keluaran farmasi",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C019",SectorID=3,CodeDesc="Fabrik/kulit atau pakaian",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C020",SectorID=3,CodeDesc="Menjahit dan menyulam",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C021",SectorID=3,CodeDesc="Barang-barang elektrik dan elektronik",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C022",SectorID=2,CodeDesc="Barang-barang komputer",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C023",SectorID=2,CodeDesc="Membuat barang-barang perubatan, saintifik dan makmal",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C024",SectorID=2,CodeDesc="Kaca dan cermin",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C025",SectorID=2,CodeDesc="Anggota badan palsu",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C026",SectorID=2,CodeDesc="Produk dibuat daripada gelas serabut, gentian sintetik, kapas tali dan produk seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C027",SectorID=2,CodeDesc="Mercun dan bahan letupan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C028",SectorID=2,CodeDesc="Gas mudah terbakar",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C029",SectorID=3,CodeDesc="Keluaran petroleum termasuk minyak pelincir dan lain-lain minyak yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C030",SectorID=3,CodeDesc="Produk berasaskan emas, perak, tembaga dan bahan-bahan yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C031",SectorID=3,CodeDesc="Peralatan sembahyang dan barang-barang lain yang berkaitan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C032",SectorID=3,CodeDesc="Batu kapur",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C033",SectorID=3,CodeDesc="Cat",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C034",SectorID=3,CodeDesc="Kertas dan hasil-hasil kertas",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C035",SectorID=3,CodeDesc="Plastik, barang-barang daripada bahan plastik atau bahan lain yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C036",SectorID=3,CodeDesc="Kaca, barang-barang daripada bahan kaca atau bahan lain yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C037",SectorID=3,CodeDesc="Logam, barang-barang daripada bahan logam atau bahan lain yang seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C038",SectorID=3,CodeDesc="Papan dan kayu",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C039",SectorID=3,CodeDesc="Perabot",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C040",SectorID=3,CodeDesc="Barang-barang tembikar",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C041",SectorID=3,CodeDesc="Percetakan (berskala besar)",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C042",SectorID=3,CodeDesc="Pam dan penapis air",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C043",SectorID=3,CodeDesc="Keluaran getah",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C044",SectorID=3,CodeDesc="Tirai dan bidai",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C045",SectorID=3,CodeDesc="Alat tulis/buku/majalah",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C046",SectorID=3,CodeDesc="Barang-barang mainan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C047",SectorID=3,CodeDesc="Barangan pertanian dan kimia industri",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C048",SectorID=3,CodeDesc="Blok ais",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C049",SectorID=3,CodeDesc="Visual iklan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C050",SectorID=3,CodeDesc="Makanan dan seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="C051",SectorID=3,CodeDesc="Minuman dan seumpamanya",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D001",SectorID=4,CodeDesc="Alat ganti dan aksesori",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D002",SectorID=4,CodeDesc="Pemasangan penyaman udara di kenderaan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D003",SectorID=4,CodeDesc="Kenderaan bermotor dan kenderaan marin",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D004",SectorID=4,CodeDesc="Tayar",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D005",SectorID=4,CodeDesc="Mencuci dan/atau mengilap kereta",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D006",SectorID=4,CodeDesc="Menyembur cat, selulosa dan bahan-bahan kimia lain",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D007",SectorID=4,CodeDesc="Kerja-kerja kejuruteraan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D008",SectorID=4,CodeDesc="Kerja-kerja kimpalan",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="D009",SectorID=4,CodeDesc="Pertukangan batu, kayu, kaca dan logam (termasuk papan iklan) ",DefaultRate=2.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E001",SectorID=5,CodeDesc="Menternak burung walit",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E002",SectorID=5,CodeDesc="Menternak lebah, lintah, cacing dan seumpamanya",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E003",SectorID=5,CodeDesc="Tempat pembiakan haiwan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E004",SectorID=5,CodeDesc="Rumah sembelihan binatang",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E005",SectorID=5,CodeDesc="Kolam pancing",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="E006",SectorID=5,CodeDesc="Semaian tumbuhan",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="F001",SectorID=6,CodeDesc="Mana-mana aktiviti perniagaan yang tidak termasuk dalam Jadual",DefaultRate=1.5f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="G001",SectorID=7,CodeDesc="Restoran/kedai makan/gerai makan/kios makanan",DefaultRate=10.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="G002",SectorID=7,CodeDesc="Menjual makanan/minuman (tanpa tempat makan)",DefaultRate=10.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="G003",SectorID=7,CodeDesc="Katering makanan",DefaultRate=10.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="G004",SectorID=7,CodeDesc="Kantin sekolah",DefaultRate=10.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="G005",SectorID=7,CodeDesc="Kantin pejabat",DefaultRate=10.0f,BaseFee=0.0f,ExtraFee=0.0f,ExtraUnit=0,Period="Y",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="H001",SectorID=8,CodeDesc="Hotel (Kelas Pertama)",DefaultRate=0.0f,BaseFee=150.0f,ExtraFee=0.0f,ExtraUnit=0,Period="M",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="H002",SectorID=8,CodeDesc="Hotel (Kelas Kedua)",DefaultRate=0.0f,BaseFee=100.0f,ExtraFee=0.0f,ExtraUnit=0,Period="M",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="H003",SectorID=8,CodeDesc="Hotel (Kelas Ketiga)",DefaultRate=0.0f,BaseFee=30.0f,ExtraFee=0.0f,ExtraUnit=0,Period="M",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="H004",SectorID=8,CodeDesc="Lodging House/Rumah Tumpangan",DefaultRate=0.0f,BaseFee=30.0f,ExtraFee=0.0f,ExtraUnit=0,Period="M",Mode=1,PQuantity=1},
                new BusinessCode {CodeNumber="I001",SectorID=9,CodeDesc="Barang Lupus/Dealing in Scrap",DefaultRate=0.0f,BaseFee=25.0f,ExtraFee=0.0f,ExtraUnit=0,Period="M",Mode=1,PQuantity=3},
            };
            ...
            var hawkerTypes = new List<HawkerType>
            {
                new HawkerType {HawkerTypeDesc="Penjaja Bergerak",Fee=48.0f,Period=1,PeriodQuantity=1},
                new HawkerType {HawkerTypeDesc="Penjaja Statik: Makanan",Fee=10.0f,Period=2,PeriodQuantity=1},
                new HawkerType {HawkerTypeDesc="Penjaja Statik: Selain daripada makanan",Fee=15.0f,Period=2,PeriodQuantity=1},
                new HawkerType {HawkerTypeDesc="Penjaja Sementara",Fee=15.0f,Period=2,PeriodQuantity=1},
                new HawkerType {HawkerTypeDesc="Penjaja Sementara",Fee=0.5f,Period=4,PeriodQuantity=1},
                new HawkerType {HawkerTypeDesc="Pasar Malam",Fee=1.0f,Period=4,PeriodQuantity=1},
            };
            hawkerTypes.ForEach(s => context.HawkerTypes.Add(s));
            context.SaveChanges();
        }
    }
}
