namespace TradingLicense.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TradingLicense.Data.LicenseApplicationContext>
    {
        ...
        protected override void Seed(TradingLicense.Data.LicenseApplicationContext context)
        {
            ...
            {
                new Users {FullName="Abd Aziz Bin Hamzah",Username="aziz",Password="rGWQ/rZGq74=",Email="aziz.h@pl.gov.my", ROLEID=6,DepartmentID=1},
                new Users {FullName="Soffiyan Bin Hadis",Username="soffiyan",Password="rGWQ/rZGq74=",Email="soffiyan.hadis@pl.gov.my", ROLEID=4,DepartmentID=1},
                new Users {FullName="Hjh. Simai Binti Md Jamil",Username="simai",Password="rGWQ/rZGq74=",Email="simai@pl.gov.my", ROLEID=3,DepartmentID=1},
                new Users {FullName="Suwardi Binti Muali",Username="suwardi",Password="rGWQ/rZGq74=",Email="suwardi.muali.pl@1govuc.gov.my", ROLEID=2,DepartmentID=1},
                new Users {FullName="Adey Suhaimi Bin Suhaili",Username="adey",Password="rGWQ/rZGq74=",Email="adey.suhaimi.pl@1govuc.gov.my", ROLEID=3,DepartmentID=1},
                new Users {FullName="Azean Irdawati Binti Wahid",Username="azean",Password="rGWQ/rZGq74=",Email="azean.wahid.pl@1govuc.gov.my", ROLEID=3,DepartmentID=1},
                new Users {FullName="Kazlina Binti Kassim",Username="kazlina",Password="rGWQ/rZGq74=",Email="kazlina@yahoo.com", ROLEID=3,DepartmentID=1},
                new Users {FullName="Johaniza Binti Jonait",Username="johaniza",Password="rGWQ/rZGq74=",Email="johaniza@yahoo.com", ROLEID=3,DepartmentID=1},
                new Users {FullName="Rafidah Binti Mohd Isa",Username="rafidah",Password="rGWQ/rZGq74=",Email="rafidah@yahoo.com", ROLEID=2,DepartmentID=1},
                new Users {FullName="Ahmad Jais Bin Halon",Username="ahmadjais",Password="rGWQ/rZGq74=",Email="ahmad.jais@yahoo.com", ROLEID=2,DepartmentID=1},
                new Users {FullName="YBHG. Datuk Azhar Bin Ahmad",Username="kpe",Password="rGWQ/rZGq74=",Email="azharahmad@pl.gov.my", ROLEID=7,DepartmentID=1},
                new Users {FullName="Mazalan Bin Hassin",Username="mazalan",Password="rGWQ/rZGq74=",Email="mazalan.hassin@pl.gov.my", ROLEID=8,DepartmentID=1},
                new Users {FullName="R. Norasliana Binti Ramlee",Username="norasliana",Password="rGWQ/rZGq74=",Email="ana.ramli@pl.gov.my", ROLEID=8,DepartmentID=1},
                new Users {FullName="Jabatan Bomba & Penyelamat Malaysia",Username="bomba",Password="rGWQ/rZGq74=",Email="jbpm_labuan.bomba@1govuc.gov.my", ROLEID=5,DepartmentID=1},
                new Users {FullName="Wakil Bahagian Perancangan",Username="bpp",Password="rGWQ/rZGq74=",Email="bpp@pl.gov.my", ROLEID=5,DepartmentID=3},
                new Users {FullName="Wakil Unit Kesihatan",Username="uks",Password="rGWQ/rZGq74=",Email="uks@pl.gov.my", ROLEID=5,DepartmentID=5},
                new Users {FullName="Wakil Jabatan Penilaian",Username="jppph",Password="rGWQ/rZGq74=",Email="jppph@pl.gov.my", ROLEID=5,DepartmentID=4},
                new Users {FullName="Ronny Jimmy",Username="ronny",Password="rGWQ/rZGq74=",Email="ronnyrtg@yahoo.com", ROLEID=8,DepartmentID=1},
            };
